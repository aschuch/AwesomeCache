...
public class Cache<T: NSCoding> {
    ...
    public func removeObjectForKey(key: String) {
        ...
        dispatch_async(diskWriteQueue) {
            ...
            do {
                ...
                print("Could not remove item at path: \(error)")
            }
        }
    }
    ...
    public func removeAllObjects() {
        ...
        dispatch_async(diskWriteQueue) {
            do {
                ...
                print("Could not remove all objects: \(error)")
            }
        }
    }
    ...
    */
    public func removeExpiredObjects() {
        dispatch_async(diskWriteQueue) {
            do {
                ...
                print("Could not remove expired objects: \(error)")
            }
        }
    }
    ...
    private func sanitizedKey(key: String) -> String {
        let regex = try! NSRegularExpression(pattern: "[^a-zA-Z0-9_]+" as String, options: NSRegularExpressionOptions())
